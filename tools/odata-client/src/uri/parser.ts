 ...
 */
export const parseQueryString = (input: string | Readonly<Record<string, string | string[] | undefined>>): ODataQueryOptions => {
  ...
  const result: ODataQueryOptions = {
    ...
    ...(params.$top !== undefined && { $top: Number.parseInt(params.$top, 10) }),
    ...(params.$skip !== undefined && { $skip: Number.parseInt(params.$skip, 10) }),
