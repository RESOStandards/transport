...
import { getErrorTargets, isODataError, parseODataError } from '../src/response/error.js';
import { extractAnnotations, extractEntityData, isODataCollection } from '../src/response/parser.js';
import type { ODataErrorBody, ODataResponse } from '../src/types.js';
...
describe('extractAnnotations', () => {
  it('extracts all annotations', () => {
    ...
    expect(annotations.context).toBe('http://localhost:8080/$metadata#Property/$entity');
