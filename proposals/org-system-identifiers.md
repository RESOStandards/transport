...
| **Status** | IN PROGRESS |
| **Date Ratified** | TBD |
| **Dependencies** | [Data Dictionary 2.1+](https://dd.reso.org/DD2.1/) (the Model Resource and its `Shape` model type)<br />[RCP-45 Legacy and Deprecated Data Elements](https://github.com/RESOStandards/transport/pull/104) (the deprecation mechanism of Section 2.1)<br />[Web API Core 2.0.0+](./web-api-core.md)<br />[OData 4.01](https://docs.oasis-open.org/odata/odata/v4.01/odata-v4.01-part1-protocol.html) |
...
The following shows an Organization Resource response, a System Resource response, a record whose top-level identifiers reconcile against a Provenance chain, and an organization mid-promotion from a locally issued identifier to a RESO-issued one. Identifiers are shown in their URN form; values are illustrative. The bodies shown are record bodies: the context URL and other response annotations are omitted, as are properties that carry no value in the case shown.
